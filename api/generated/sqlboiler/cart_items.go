...
var CartItemWhere = struct {
	...
	UserID:   whereHelperint64{field: "\"cart_items\".\"user_id\""},
	ProdID:   whereHelperint64{field: "\"cart_items\".\"prod_id\""},
...
func (r *cartItemR) GetProd() *Product {
	if r == nil {
		return nil
	}
	return r.Prod
...
var (
	cartItemAllColumns            = []string{"id", "user_id", "prod_id", "quantity"}
	cartItemColumnsWithoutDefault = []string{"user_id", "prod_id", "quantity"}
...
func (o *CartItem) Prod(mods ...qm.QueryMod) productQuery {
...
func (o *CartItem) User(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
func (cartItemL) LoadProd(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCartItem interface{}, mods queries.Applicator) error {
	var slice []*CartItem
	var object *CartItem
	...
	if singular {
		...
		foreign.R.ProdCartItems = append(foreign.R.ProdCartItems, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.ProdID == foreign.ID {
				...
				foreign.R.ProdCartItems = append(foreign.R.ProdCartItems, local)
				break
			}
		}
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (cartItemL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCartItem interface{}, mods queries.Applicator) error {
	var slice []*CartItem
	var object *CartItem
...
// SetProd of the cartItem to the related item.
// Sets o.R.Prod to related.
// Adds o to related.R.ProdCartItems.
func (o *CartItem) SetProd(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Product) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &productR{
			ProdCartItems: CartItemSlice{o},
		}
	} else {
		related.R.ProdCartItems = append(related.R.ProdCartItems, o)
	}

	return nil
}

// SetUser of the cartItem to the related item.
// Sets o.R.User to related.
// Adds o to related.R.CartItems.
func (o *CartItem) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
