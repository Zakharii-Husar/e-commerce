...
type TaxRate struct {
	...
	// (GST, PST, HST)
	TaxType     string        `boil:"tax_type" json:"tax_type" toml:"tax_type" yaml:"tax_type"`
	...
	TaxProvince string        `boil:"tax_province" json:"tax_province" toml:"tax_province" yaml:"tax_province"`
...
var TaxRateTableColumns = struct {
	...
	ID:          "tax_rates.id",
	TaxType:     "tax_rates.tax_type",
	TaxRate:     "tax_rates.tax_rate",
	Province:    "tax_rates.province",
	TaxProvince: "tax_rates.tax_province",
}
...
var TaxRateWhere = struct {
	ID          whereHelperint64
	TaxType     whereHelperstring
	TaxRate     whereHelpertypes_Decimal
	Province    whereHelperstring
	TaxProvince whereHelperstring
}{
	ID:          whereHelperint64{field: "\"tax_rates\".\"id\""},
	TaxType:     whereHelperstring{field: "\"tax_rates\".\"tax_type\""},
	TaxRate:     whereHelpertypes_Decimal{field: "\"tax_rates\".\"tax_rate\""},
	Province:    whereHelperstring{field: "\"tax_rates\".\"province\""},
	TaxProvince: whereHelperstring{field: "\"tax_rates\".\"tax_province\""},
}
...
type taxRateR struct {
	TaxProducts ProductSlice `boil:"TaxProducts" json:"TaxProducts" toml:"TaxProducts" yaml:"TaxProducts"`
}
...
func (r *taxRateR) GetTaxProducts() ProductSlice {
	if r == nil {
		return nil
	}
	return r.TaxProducts
}
...
var (
	taxRateAllColumns            = []string{"id", "tax_type", "tax_rate", "province", "tax_province"}
	taxRateColumnsWithoutDefault = []string{"tax_type", "tax_rate", "province", "tax_province"}
	taxRateColumnsWithDefault    = []string{"id"}
...
// TaxProducts retrieves all the product's Products with an executor via tax_id column.
func (o *TaxRate) TaxProducts(mods ...qm.QueryMod) productQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"products\".\"tax_id\"=?", o.ID),
	)

	return Products(queryMods...)
}

// LoadTaxProducts allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (taxRateL) LoadTaxProducts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTaxRate interface{}, mods queries.Applicator) error {
	var slice []*TaxRate
	var object *TaxRate
	...
	query := NewQuery(
		qm.From(`products`),
		qm.WhereIn(`products.tax_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.TaxProducts = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.TaxID {
				local.R.TaxProducts = append(local.R.TaxProducts, foreign)
				if foreign.R == nil {
					foreign.R = &productR{}
				}
				foreign.R.Tax = local
...
// AddTaxProducts adds the given related objects to the existing relationships
// of the tax_rate, optionally inserting them as new records.
// Appends related to o.R.TaxProducts.
// Sets related.R.Tax appropriately.
func (o *TaxRate) AddTaxProducts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Product) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.TaxProducts = append(o.R.TaxProducts, related...)
	}
