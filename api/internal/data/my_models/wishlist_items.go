...
var WishlistItemTableColumns = struct {
	...
	UserID: "wishlist_items.user_id",
	ProdID: "wishlist_items.prod_id",
}
...
var WishlistItemWhere = struct {
	...
	ID:     whereHelperint64{field: "\"wishlist_items\".\"id\""},
	UserID: whereHelperint64{field: "\"wishlist_items\".\"user_id\""},
	ProdID: whereHelperint64{field: "\"wishlist_items\".\"prod_id\""},
}
...
func (r *wishlistItemR) GetProd() *Product {
	if r == nil {
		return nil
	}
	return r.Prod
...
func (r *wishlistItemR) GetUser() *User {
	if r == nil {
		return nil
	}
	return r.User
...
var (
	wishlistItemAllColumns            = []string{"id", "user_id", "prod_id"}
	wishlistItemColumnsWithoutDefault = []string{"user_id", "prod_id"}
...
func (o *WishlistItem) Prod(mods ...qm.QueryMod) productQuery {
...
func (o *WishlistItem) User(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
func (wishlistItemL) LoadProd(ctx context.Context, e boil.ContextExecutor, singular bool, maybeWishlistItem interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.ProdWishlistItems = append(foreign.R.ProdWishlistItems, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.ProdID == foreign.ID {
				...
				foreign.R.ProdWishlistItems = append(foreign.R.ProdWishlistItems, local)
				break
			}
		}
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (wishlistItemL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeWishlistItem interface{}, mods queries.Applicator) error {
	var slice []*WishlistItem
	var object *WishlistItem
...
// SetProd of the wishlistItem to the related item.
// Sets o.R.Prod to related.
// Adds o to related.R.ProdWishlistItems.
func (o *WishlistItem) SetProd(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Product) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &productR{
			ProdWishlistItems: WishlistItemSlice{o},
		}
	} else {
		related.R.ProdWishlistItems = append(related.R.ProdWishlistItems, o)
	}

	return nil
}

// SetUser of the wishlistItem to the related item.
// Sets o.R.User to related.
// Adds o to related.R.WishlistItems.
func (o *WishlistItem) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func FindWishlistItem(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*WishlistItem, error) {
...
func WishlistItemExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
